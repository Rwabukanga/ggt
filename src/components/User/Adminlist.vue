                ...
                <div class="sidebar-inner slimscroll">
					<div id="sidebar-menu" class="sidebar-menu">
						<ul>
							...
							<br>
							<li> 
								<a href="/"><i class="fe fe-layout"></i> <span>View Request</span></a>
							</li>
							<br>
							<li> 
								<a href="/listmeeting"><i class="fe fe-star-o"></i><span>View Meeting</span></a>
							</li> 
							<br>
							<li> 
								<a href="doctor-list.html"><i class="fe fe-user-plus"></i> <span>View Institutions</span></a>
							</li>
							<li> 
							...
							<div class="card">
								<div class="card-body">
									<div class="table-responsive">
										 <datatable-component :options="options"  :actions="actions" :data="reggs" :columns="columns" id="userslist"></datatable-component>
									</div>
								</div>
							</div>
						</div>			
 ...
 */
      ...
      actions:[
        {
          ...
          btnFn: (id) => {
           this.$router.push({ path:'/savemeeting/'+id})
          },
          btnParamName: "id",
		  },

		{
          ...
          iconClass: "fas fa-save",
          btnFn: (id) => {
           this.$router.push({ path:'/requestcr/'+id})
          },
          btnParamName: "id",
		  },
          ...
          iconClass: "fas fa-save",
          btnFn: (id) => {
           this.$router.push({ path:'/addct/'+id})
          },
          btnParamName: "id",
		  },
  ...
  methods:{
          findreggs(){
         axios.get('http://localhost:2021/category/Admin')
         .then(response =>{
