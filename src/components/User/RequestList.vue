					...
					<!-- <li class="nav-item dropdown has-arrow">
						...
						<div class="dropdown-menu">
				           ...
				           <a class="dropdown-item" href="profile.html">My Profile</a>
							...
							<a class="dropdown-item" href="/log"  @click="logout">Logout</a>
						</div>
					</li> -->
				<li class="nav-item">
                ...
                <div class="sidebar-inner slimscroll">
					<div id="sidebar-menu" class="sidebar-menu">
						<ul>
							...
							<br>
							<li> 
								<a href="/listcategory"><i class="fe fe-layout"></i> <span>View Category</span></a>
							</li>
							<br>
							<li> 
							...
							<br>
							<li> 
								<a href="/addins"><i class="fe fe-user-plus"></i> <span>Create Institutions</span></a>
							</li>
							<br>
							<li> 
								<a href="/formsave"><i class="fe fe-user"></i> <span>Create Users</span></a>
							</li>
							<br>
							<li> 
								<a href="/usdash"><i class="fe fe-star-o"></i> <span>View Users</span></a>
							</li>
							<!-- <li> 
							...
							<!-- <li class="active"><a href="product-list.html"><i class="fe fe-layout"></i> <span>Product List</span></a></li> -->
							...
							<div class="card">
								<div class="card-body">
									<div class="table-responsive">
										<div class="nav-item">
                    <!-- <button  class="btn btn-success btn-sm" @click="findallreport"> 
                    <i class="fas fa-print"></i>
                    <span class="glyphicon glyphicon-log-out">Print All Report</span> 
                 </button>  -->
				 <a v-bind:href="'http://localhost:2021/request/report'">Print Report</a>
            </div>
...
export default {
      ...
      columns:[
...

        {
           title: 'Project Description',
            reggs: 'projectdecription'
        },

        {
            title: 'Project Delivery TimeLine',
            reggs: 'proposdeltimeline'
        },

        {
            title: 'Project Technologies',
            reggs: 'propostechnologies'
        },

        {
            title: 'Proposed Financial Budget',
            reggs: 'proposedfinancialbudget'
        },
	...
	/* 	{
      ...
      actions:[
          ...
          btnFn: (id) => {
           axios.put('http://localhost:2021/request/approve/'+id)
            .then(response => {
              this.$swal({
                    type: "success",
                    position: "top-end",
                ...
                this.$router.push({path:'/rlist',query:{alert:response.data.description}})
            });
          },
          btnParamName: "id",
          },

		  {
            ...
            axios.get('http://localhost:2021/request/'+id+'/report')
		   .then(response => {
              /* this.$swal({
                    type: "success",
                    position: "top-end",
          ...
          btnText: "reject",
          btnClass: "btn btn-white text-danger btn-sm",
          iconClass: "fas fa-eject",
          btnFn: (id) => {
           axios.put('http://localhost:2021/request/reject/'+id)
            .then(response => {
              this.$swal({
                    type: "success",
                    position: "top-end",
          ...
          btnFn: (id) => {
           axios.delete('http://localhost:2021/request/delete/'+id)
            .then(response => {
              this.$swal({
                    type: "success",
                    position: "top-end",
    ...
    methods:{
        findall(){
            axios.get('http://localhost:2021/request/all')
            .then(response => {
		...
		findallreport(){
			axios.get('http://localhost:2021/request/report')
			.then(response =>{
				this.reggs = response.data.OBJECT;
				console.log(this.reggs);
			}).catch(response =>{
        ...
        filterBy(list, value){
            ...
            return list.filter(function(regs){
                return regs.projectTitle.indexOf(value)> -1;
            });
        },
