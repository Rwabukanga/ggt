					...
					<div class="row">
						<div class="col-md-12">
							<div class="card">
								...
								<div class="card-body">
									<form class="navbar-form" v-on:submit.prevent="updateinstitution">
   ...
   <div class="form-group row">
          <div class="col-xs-20 col-sm-12 col-sm-offset col-md-4 col-md-offset-3"> 
             <div class="col-auto">
                ...
                <input name="name" type="text" class="form-control" id="firstname" placeholder="name" required  v-model="userr.name">
                </div>
          </div>
                <div class="col-xs-20 col-sm-12 col-sm-offset col-md-4 col-md-offset-3"> 
                <div class="col-auto">
                <label>E-mail</label>
                <input name="email" type="text" class="form-control" id="email" placeholder="email" required  v-model="userr.email">
              </div>
                </div>
            </div>
  ...
  name:'add',
    ...
    /*    provinces:[],
     ...
     methods:{
           ...
           fetchinstitution(id){
            axios.get('http://localhost:2021/institution/find/'+id)
            .then(response =>{
 ...
 /*   fetchProvince(){
   ...
   /*  fetchDistrict(event){
     ...
     .then(response =>{
      ...
      updateinstitution(b){
        if(!this.userr.name|| !this.userr.email|| !this.userr.phonenumber){
          alert="fill all user";
        }else{
          let newusert = {
         ...
         axios.put('http://localhost:2021/institution/update/'+this.$route.params.id, newusert)
    ...
    /* created:function(){
      ...
      created: function(){
       this.fetchinstitution(this.$route.params.id);
    },   
}
</script>
<style scoped>
