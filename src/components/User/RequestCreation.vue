                ...
                <div class="sidebar-inner slimscroll">
					<div id="sidebar-menu" class="sidebar-menu">
						<ul>
							...
							<li> 
								<a href="reviews.html"><i class="fe fe-star-o"></i> <span>View Institution</span></a>
							</li>
							<br>
							<li> 
								<a href="transactions-list.html"><i class="fe fe-activity"></i> <span>View Meeting</span></a>
							</li>
							<br>
							<!-- <li> 
          ...
          <div class="col-xs-20 col-sm-12 col-sm-offset col-md-4 col-md-offset-3"> 
            ...
            <div class="form-group row">
             ...
             <div class="col-auto">
                ...
                <textarea name="comment" type="text" class="form-control" id="comment" required placeholder="comment" v-model="userr.comment"></textarea>
                </div>
              </div>
