  	...
  	<!-- Main Wrapper -->
        <div class="main-wrapper">
            ...
            <div class="header">
				...
				<img src="src/assets/img/rss.Jpeg" alt="Logo">
					</a>
                ...
                <div class="sidebar-inner slimscroll">
					<div id="sidebar-menu" class="sidebar-menu">
						<ul>
							...
							<!-- <li> 
								<a href="/rlist"><i class="fe fe-home"></i> <span>Dashboard</span></a>
							</li> -->
							<li> 
								<a href="appointment-list.html"><i class="fe fe-layout"></i> <span>View Request</span></a>
							</li>
							<br>
							<li> 
								<a href="/listmeeting"><i class="fe fe-users"></i> <span>View Meeting</span></a>
							</li>
							<br>
							<li> 
								<a href="/usdash"><i class="fe fe-user-plus"></i> <span>View Users</span></a>
							</li>
							<br>
							<li> 
								<a href="/listcategory"><i class="fe fe-user"></i> <span>View Category</span></a>
							</li>
							<br>
							<!-- <li> 
								<a href="/listins"><i class="fe fe-star-o"></i> <span>View Institutions</span></a>
							</li> -->
							<!-- <li> 
            ...
            <div class="page-wrapper">
				...
				<div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row">
							<div class="col">
								<h3 class="page-title">Edit Category Form</h3>
  ...
  name:'add',
    ...
    /*    provinces:[],
     ...
     methods:{
           ...
           fetchmeeting(id){
            axios.get('http://localhost:2021/category/find/'+id)
            .then(response =>{
     ...
     .then(response =>{
      ...
      updateMetting(b){
        if(!this.userr.name){
         ...
         axios.put('http://localhost:2021/category/update/'+this.$route.params.id, newusert)
         ...
         .then(response =>{
            ...
            this.$swal({
                ...
                this.$router.push({path:'/listcategory',query:{alert: response.data.description}});
         });
     /*  b.preventDefault();  */
        }
     /*   b.preventDefault(); */
